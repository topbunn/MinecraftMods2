...
class DataRepository(
    private val recordAccess: RecordAccessObject,
    ...
    suspend fun getFavoriteSize() = recordAccess.getActiveRecords().size
    ...
    suspend fun addFavorite(record: LocalRecord) {
        val oldRecord = recordAccess.getRecord(record.externalId)
