...
object TabsScreen: Screen {
    ...
    override fun Content() {
        val mainScreen = rememberScreen(Destination.MainScreen) as Tab
                ...
                bottomBar = {
                    Column {
                        ...
                        Row(
                            ...
                            val favoriteScreen = rememberScreen(Destination.LikeScreen) as Tab
                            val feedbackScreen = rememberScreen(Destination.FeedbackScreen) as Tab
